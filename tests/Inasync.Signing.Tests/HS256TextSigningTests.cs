...
namespace Inasync.Signing.Tests {
    ...
    public class HS256TextSigningTests {
        ...
        public void ComputeSignature() {
            var version = (byte)Rand.Int();
            var signKey = Base16.Decode("12BEF7DA731D6A1DB6F0AA98904E54FC9822A5592FBD8DAA1535C02153A34094D7B15A1ED31EF007DDDB0CD0F0728D4985D67775CAA31ECF5BD23B2CC4004614");
            ...
            new[] {
                ...
                TestCase( 1, ""      , new UrlSafeSignature(version, Base16.Decode("1d1ca4d8b9b68c3416d2e31bbcb9a80e4d0ce83a14676e2f73acea7254414a1b")), null),
                TestCase( 2, "A"     , new UrlSafeSignature(version, Base16.Decode("22ebf48a60160e341eac898fd816d0a798ec93651b29c7bb18497e0907843056")), null),
                TestCase( 3, "${FOO}", new UrlSafeSignature(version, Base16.Decode("3fc90fb91d915c3262e214d9fcac2bd18dca6cc97325b6f0aa4c9eb32415ae12")), null),
            }.Run();
        }
    }
}
